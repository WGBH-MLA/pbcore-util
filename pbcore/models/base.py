...
class PBCoreElement(PBCoreBaseModel):
    """Base class for PBCore elements base attributes."""
...
class PBCoreText(PBCoreBaseModel):
    """Base class for PBCore elements that have a text attriburte, i.e. content within the node instead of child nodes."""
